    ...
    <div class="max-w-container-max mx-auto px-gutter">
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            <div class="lg:col-span-5 space-y-8">
                <div>
                    <span class="inline-block px-4 py-1.5 bg-prestige-gold/10 text-prestige-gold font-label-sm text-xs rounded-full uppercase tracking-wider mb-4 font-bold">Kết nối với chúng tôi</span>
                    <h1 class="font-display-lg text-4xl md:text-5xl font-bold text-deep-navy leading-tight mb-6">Liên hệ với <br/><span class="text-prestige-gold">The Leaders Hub</span></h1>
                    <p class="font-body-md text-body-md text-on-surface-variant leading-relaxed">
                        Hãy gửi yêu cầu của bạn bằng cách sử dụng biểu mẫu hoặc liên hệ trực tiếp với chúng tôi qua thông tin liên hệ dưới đây.
                    </p>
                </div>
                ...
                <div class="space-y-6 bg-white p-8 rounded-2xl border border-surface-container-high shadow-sm">
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <p class="font-label-sm text-xs text-on-surface-variant uppercase mb-1">Hotline tư vấn</p>
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <p class="font-label-sm text-xs text-on-surface-variant uppercase mb-1">Địa chỉ Email</p>
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <p class="font-label-sm text-xs text-on-surface-variant uppercase mb-1">Trụ sở chính</p>
                ...
                <div class="rounded-2xl overflow-hidden shadow-lg h-64 relative group">
                    <div class="bg-cover bg-center w-full h-full grayscale group-hover:grayscale-0 transition-all duration-700" style="background-image: url('https://lh3.googleusercontent.com/aida-public/AB6AXuC5AQWvOaUndJeICTK6aWY61WATQwdfTV4BPJ2a9XRMX0uO3khen4I9NqRiRLnj3Bf8gRprA7d7ssA-qRvCqDbT48_joZG3I7YuGIzb34Lx_LpwWwW6iz_NCyDhPxhCn12EyuSDjoJWCgj-NQ7lA4WgM_Zokh7ZackMMFEPa0ojmucd17f4Up1meDucWoJ9FCXrOnvEGHiOoqSAiKbaDOj5_5M0xuRVfzXXf7Q7ezXpR_a8ITcFiUQ7uW56M8QK5pLN2GXZ_mE4vMGx')"></div>
                    ...
                    <div class="absolute bottom-4 left-4 bg-white/90 backdrop-blur px-4 py-2 rounded-lg shadow-sm">
                        <p class="font-label-sm text-xs text-deep-navy font-bold">Capital Place, Hà Nội</p>
                    </div>
                </div>
            </div>
